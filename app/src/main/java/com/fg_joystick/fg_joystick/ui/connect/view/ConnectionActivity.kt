...
import com.fg_joystick.fg_joystick.ui.connect.view_model.ConnectionViewModel
import com.fg_joystick.fg_joystick.ui.connect.view_model.ConnectionViewModelFactory
...
class ConnectionActivity : AppCompatActivity() {
    ...
    private fun updateUiWithUser(model: ConnectedUserView) {
        ...
        val switchActivityIntent = Intent(this, JoystickActivity::class.java)
